...
async function wakeUpServer() {
    try {
        await fetch('https://dice-roller-azure-dna3engebka0e3hf.centralus-01.azurewebsites.net', { method: 'GET' });
    } catch (error) {
...
async function rollDie(initialRoll = false, isPlayer = true) {
    try {
        const response = await fetch('https://dice-roller-azure-dna3engebka0e3hf.centralus-01.azurewebsites.net/roll');
